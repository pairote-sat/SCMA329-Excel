...
::: {.example}
**Example 1**. *You plan to invest today with an interest rate of 3% per
...
::: {.example}
**Example 2**. *How much should you deposit into the account with an
...
::: {.example}
**Example 3**. *Let $i$ be the constant effective rate of interest per
...
::: {.example}
**Example 4**. *Let $i$ be the constant effective rate of interest per
...
::: {.example}
**Example 5**. *Given the effective rate of interest of $8\%$ p.a., use
Excel to calculate*
...
::: {.example}
**Example 6**. *Let $i = 4\%$ effective per time unit. Cashflows are
given as follows:*
